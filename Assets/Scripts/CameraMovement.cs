...
{
    [FormerlySerializedAs("_speed")] [FormerlySerializedAs("Speed")] [SerializeField]
    private float speed = 100.0f;

    [FormerlySerializedAs("_mouseSensitivity")] [FormerlySerializedAs("MouseSensitivity")] [SerializeField]
    private float mouseSensitivity = 0.6f;

    [FormerlySerializedAs("_verticalAngleLimit")] [FormerlySerializedAs("VerticalAngleLimit")] [SerializeField]
